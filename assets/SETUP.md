...
You can also adjust many other settings in [config.py](config.py), such as the models to use, default thinking level, model paramenters, safety settings, system prompt, help text, default prompts for different content types, and more.
